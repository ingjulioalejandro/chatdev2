...
<style type="text/css">
	...
	#radio_filesSharing:checked ~ #inner_right_pannel{
	...
	<div id="wrapper">
		...
		<div id="left_pannel">
			...
			<div id="user_info" style="padding: 10px;">
				...
				<br>
				<div>
					<label style="align-items: center;" id="label_chat" for="radio_chat">Chat <img src="ui/icons/nchat.png"></label>
					<label id="label_contacts" for="radio_contacts">Contacts <img src="ui/icons/ncontacts.png"></label>
					<label id="label_settings" for="radio_settings">Settings <img src="ui/icons/nsettings.png"></label>
					<label id="fileSharing" for="radio_filesSharing" href="../Plug_SharingApp/index.php">Files Sharing <img src="ui/icons/fileSharing.png"></label>
					<label id="logout" for="radio_logout">Logout <img src="ui/icons/nlogout.png"></label>
		...
		<div id="right_pannel">
			<div id="header">
				<div id="loader_holder" class="loader_off"><img style="width:70px;" src="ui/icons/giphy.gif"></div>
			...
			<div id="container" style="display: flex;">
				...
				<input type="radio" id="radio_filesSharing" name="myradio" style="display: none;">
...
<script type="text/javascript">
	...
	var label_fileSharing = _("fileSharing");
	label_fileSharing.addEventListener("click",get_fileSharing);
...
<script type="text/javascript">
	...
	function send_dataUpload(files){

		var xml = new XMLHttpRequest();
		var myform = new FormData();
		var filename = files[0].name;
		myform.append('file',files[0]);
		xml.open("POST","filesSharing_Upload.php",true);
		xml.send(myform);
   	...
   	function upload_profile_image(files){
		...
		var ext2 = filename.substr(ext_start + 1,4);
   		if(!(ext == "jpg" || ext == "JPG" || ext2 == "jpeg" || ext2 == "JPEG" || ext == "png" || ext == "PNG")){
	...
	function upload_file(e){
		var message_text = _("uploadFileName");

		send_dataUpload(message_text.files);
		get_data({},"filessharing");
	}
