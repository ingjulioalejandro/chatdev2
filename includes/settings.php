			...
			.dragging{
				border: dashed 2px #aaa;
		 		...
		 		<div style="display:flex;animation: appear 1s ease">
		 			...
		 			<img ondragover="handle_drag_and_drop(event)" ondrop="handle_drag_and_drop(event)" ondragleave="handle_drag_and_drop(event)" src="'.$image.'" style="width:200px;height:200px;margin:10px;border-radius: 50%;" />
					...
					<form id="myform" >
						...
						<input style="background-color: #27344b;color: white; border: solid 2px white;border-radius: 5px" type="button" value="Save Settings" id="save_settings_button" onclick="collect_data(event)" ><br>
